...
if (request.getAttribute("buscarprod") == null) {
...
<body>
 ...
 %>
    ...
    <div>
      Se eliminó el producto correctamente.
		...
		<form class="d-flex" action="abmcProductos" method="get">
			<div class="5" style="margin-right: 200px;margin-left:20mm">
  ...
  <path
			...
			<div class="col-3" style="margin-right: 10px; margin-left: 70mm">
				<input type="hidden" class="form-control" id="accion" name="accion"
					...
					class="form-control" id="buscar" name="buscar" placeholder="Ingrese descripcion"
					aria-label="Search">
			</div>
			<div class="col-2">
  ...
  <input class="form-check-input" value="sinStock" type="radio"   name="filtro" id="flexRadioDefault1">
  <label class="form-check-label" for="flexRadioDefault1" >
    Productos sin stock
  </label>
</div>
<div class="form-check">
  <input class="form-check-input" value="todos" type="radio" name="filtro" id="flexRadioDefault2">
